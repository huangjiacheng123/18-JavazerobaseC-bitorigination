...
<body>
	...
	<div id="news1" class="text-center"
		style="background: linear-gradient( 	#FFEFD5, 	#FFEBCD)">
		<div class="container">
			<form action="<%=request.getContextPath()%>/search" method="post"
				id="searchstyle">
				<input type="text" name="key" class="inlink" placeholder='id' />
				<input type="text" name="key" class="inlink" placeholder='method' />
				<input type="text" name="key" class="inlink" placeholder='type' />
						...
						if (application.getAttribute("search2") == null) {
							...
							for (int i = 0; i < listmap.size(); i++) {
								...
								if (i % 2 == 0) {
									...
									out.print("<td align:center><button class='delete-button' type='submit'><a href='" + path
											+ "/delete?id=" + listmap.get(i).get("id")
											+ "' class='alink'>delete</a></button></td>");
									out.print("</tr>");
								} else {
									out.print("<tr>");
									for (String col : cols) {
