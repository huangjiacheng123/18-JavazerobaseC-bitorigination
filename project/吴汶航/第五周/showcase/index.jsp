...
<link rel="stylesheet" type="text/css" href="css/according.css">
<link rel="stylesheet" type="text/css" href="css/buitin.css">
</head>
...
<body>
	...
	<div id="news1" class="text-center">
		<div id="according" class="container">
			<form action="<%=request.getContextPath()%>/search" method="post"
				id="searchstyle">
				<div id="in_buit">
					<input id="in_sub_1" type="text" name="key" placeholder='请输入关键字' /> 
					<input id="submit_1" type="image" src="image/sousuo.png" width="100" height="100"/>
				</div>
			</form>
			<div id="message2"">
				<p class="result" id="message2">
					...
					<%
						...
						if (application.getAttribute("search2") == null) {
							...
							out.print("<table border='1' align='center' id='customers'>");
							//绘制表头
							...
							out.print("<th align='center' colspan='2'>" + "operation" + "</th>");
							out.print("</tr>");
							//绘制数据
							...
							for (int i = 0; i < listmap.size(); i++) {
								...
								if (i % 2 == 0) {
									...
									out.print(
											"<td align='center'><button class='delete-button' type='submit'><a id='delete_a' href='"
													+ path + "/delete?id=" + listmap.get(i).get("id")
													+ "'>delete</a></button></td>");
									out.print("</tr>");
								} else {
									out.print("<tr>");
							...
							for (int i = 0; i < listmap.size(); i++) {
								...
								if (i % 2 == 0) {
									...
									out.print("<td align='center'><button class='delete-button' type='submit'><a id='delete_a' href='" + path
											+ "/delete?id=" + listmap.get(i).get("id") + "'>delete</a></button></td>");
									out.print("</tr>");
								} else {
									out.print("<tr>");
									for (String col : cols) {
