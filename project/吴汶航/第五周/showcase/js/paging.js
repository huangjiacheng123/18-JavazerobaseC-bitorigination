//吴汶航
var theTable = document.getElementById("customers");
...
var header = document.getElementById("spanFirst");
...
function next() {
	...
	for (var i = currentRow-1; i < maxRow; i++) {
		if(i<currentRow){
...
function pre() {
	...
	for (var i = maxRow-1; i < currentRow; i++) {
		if(i<maxRow){
			theTable.rows[0].style.display = '';
		} else{
			theTable.rows[i].style.display = '';
