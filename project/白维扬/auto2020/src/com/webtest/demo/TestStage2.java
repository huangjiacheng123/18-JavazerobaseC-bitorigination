...
public class TestStage2 extends BaseTest {
	@BeforeMethod
	public void login() throws InterruptedException {
		webtest.open("http://xinhu:8888/");
	...
	@Test
	public void test_give_public_notice_1() throws InterruptedException {
	...
	@Test
	public void test_give_public_notice_2() throws InterruptedException {
		webtest.click("id=menu_list_num42");
		webtest.click("xpath=//a[text()='通知公告']");
		webtest.enterFrame1("xpath=//iframe[@name='openinputiframe']");
		webtest.type("name=title", "this is a title");
		...
		webtest.leaveFrame();
		webtest.enterFrame1("xpath=//iframe[@name='openinputiframe']");
		webtest.type("xpath=//span[@id='div_url']//input", "www.baidu.com");
		Thread.sleep(500);
		webtest.click("id=AltS");
		webtest.leaveFrame();
		Assert.assertTrue(webtest.isDisplayed("xpath=//div[text()='新增保存成功']"));
	...
	@Test
	public void test_give_public_notice_3() throws InterruptedException {
		webtest.click("id=menu_list_num42");
		webtest.click("xpath=//a[text()='通知公告']");
		webtest.enterFrame1("xpath=//iframe[@name='openinputiframe']");
		webtest.type("name=title", "this is a title");
		webtest.selectByIndex("name=typename", 1);
		webtest.type("id=filed_fengmian_inp", "/Users/baiweiyang/eclipse-workspace/auto2020/img/1.png");
	...
	@Test
	public void test_meeting1() throws InterruptedException {
		webtest.click("id=menu_list_num42");
	...
	@Test
	public void test_meeting2() throws InterruptedException {
		webtest.click("id=menu_list_num42");
		webtest.click("xpath=//a[text()='会议']");
		webtest.enterFrame1("xpath=//iframe[@name='openinputiframe']");
		webtest.selectByIndex("name=hyname", 1);
	...
	@Test
	public void test_receive_thing1() throws InterruptedException {
		webtest.click("id=menu_list_num42");
	...
	@Test
	public void test_receive_thing2() throws InterruptedException {
		webtest.click("id=menu_list_num42");
		webtest.click("xpath=//a[text()='物品领用']");
		webtest.enterFrame1("xpath=//iframe[@name='openinputiframe']");
		webtest.click("xpath=//form[@name='myform']//a[@class='webbtn']");
	...
	@Test
	public void test_buy_thing1() throws InterruptedException {
		webtest.click("id=menu_list_num42");
	...
	@Test
	public void test_buy_thing2() throws InterruptedException {
		webtest.click("id=menu_list_num42");
		webtest.click("xpath=//a[text()='物品采购']");
		webtest.enterFrame1("xpath=//iframe[@name='openinputiframe']");
		webtest.click("xpath=//form[@name='myform']//a[@class='webbtn']");
		...
		webtest.click("xpath=//input[starts-with(@id,'changeok')]");
		webtest.typeAndClear("xpath=//input[@name='count0_0']", "1");
		webtest.type("xpath=//input[@name='custname']", "white");
	...
	public void test_seal3() throws InterruptedException {
		...
		webtest.type("id=filed_sealimg_inp", "/Users/baiweiyang/eclipse-workspace/auto2020/img/1.png");
